                ...
                <form action="{{route('register')}}" method="POST">
                    ...
                    <div class="panel panel-body login-form">
                        <div class="text-center">
                            ...
                            <h5 class="content-group">Register new account <small class="display-block">Your credentials</small></h5>
                        </div>
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn bg-blue btn-block">REGISTER <i class="icon-arrow-left13 position-right"></i></button>
                        </div>

                        <div class="content-divider text-muted form-group"><span>or login with</span></div>
                        <ul class="list-inline form-group list-inline-condensed text-center">
                            ...
                            <li><a href="{{url('redirect/google')}}" class="btn border-pink-300 text-pink-300 btn-flat btn-icon btn-rounded"><i class="icon-google"></i></a></li>
                            <li><a href="{{url('redirect/github')}}" class="btn border-slate-600 text-slate-600 btn-flat btn-icon btn-rounded"><i class="icon-github"></i></a></li>
                        </ul>
