...
window.Echo.join('chat').here(function (users) {
  ...
  users.forEach(function (user) {
    ...
    $('#online-users').append("<li class=\"media\" id=\"user-".concat(user.id, "\">\n                                     <a href=\"#\" class=\"media-link\">\n                                        <div class=\"media-body\" >\n                                            <span class=\"media-heading text-semibold\">").concat(user.name, "</span>\n                                        </div>\n                                        <div class=\"media-right media-middle\">\n                                            <span class=\"status-mark bg-success\"></span>\n                                        </div>\n                                    </a>\n                                </li>"));
  });
  console.log(users);
...
$(document).on("keypress.key102", function (event) {
  if ($('#chat-text').is(':visible')) {
    if (event.which == 13) {
      ...
      var body = $('#chat-text').val();
      console.log(body);
      $('#send-chat').append("\n                <li class=\"media\" >\n                                    <div class=\"media-body container\">\n                                        <div class=\"media-content bg-slate\">".concat(body, "</div>\n                                        <span class=\"media-annotation display-block mt-10\">").concat(new Date(time).getHours(), " :  ").concat(new Date(time).getUTCMinutes(), "<a href=\"#\"><i class=\"icon-pin-alt position-right text-muted\"></i></a></span>\n                                    </div>\n\n                                </li>\n                "));
      var data = {
        '_token': $('meta[name=csrf-token]').attr('content'),
        body: body
      };
...
window.Echo.channel('laravel_database_send-messages').listen('sendEvent', function (e) {
  console.log(e.message);
  $('#send-chat').append("\n                <li class=\"media reversed\" id=\"media-reversed\">\n                                    <div class=\"media-body container\">\n                                        <div class=\"media-content bg-info\">".concat(e.message.body, "</div>\n                                        <span class=\"media-annotation display-block mt-10\">").concat(new Date(e.message.created_at).getHours(), " :  ").concat(new Date(e.message.created_at).getUTCMinutes(), "<a href=\"#\"><i class=\"icon-pin-alt position-right text-muted\"></i></a></span>\n                                    </div>\n\n                                </li>\n                "));
});
var userid = $('meta[name=user_id]').attr('content'); /// Event Imbalances Statues////
...
window.Echo.channel('laravel_database_private-App.Models.User.' + userid).notification(function (e) {
  if (e.type == 'App\\Notifications\\ImbalancesNotify') {
    console.log(e);
    $('#list-notify').append("<li class=\"media\">\n\n\n                            <div class=\"media-body\">\n                                <a href=\"/data/".concat(e.imbalances_id, "\" class=\"media-heading\">\n                                    <span class=\"text-semibold\"> Admin : ").concat(e.admin, "</span>\n                                    <br>\n                                    <span class=\"text-semibold\"> Name Imbalance : ").concat(e.name_imbalance, "</span>\n                                    <span class=\"media-annotation pull-right\">Time: ").concat(new Date(time).getHours(), " :  ").concat(new Date(time).getUTCMinutes(), "</span>\n                                </a>\n\n                                <span class=\"text-muted\"> Status: ").concat(e.status, "</span>\n                            </div>\n\n                        </li>"));
    document.getElementById('notifications_count').innerHTML = e.count;
  } else if (e.type == 'App\\Notifications\\AddImbalances') {
    console.log(e);
    $('#list-notify').append("<li class=\"media\">\n\n\n                            <div class=\"media-body\">\n                                <a href=\"/all/".concat(e.user_id, "\" class=\"media-heading\">\n                                    <span class=\"text-semibold\"> user : ").concat(e.user, "</span>\n                                    <br>\n                                    <span class=\"text-semibold\"> Name Imbalance : ").concat(e.name_bug, "</span>\n                                    <span class=\"media-annotation pull-right\">Time: ").concat(new Date(time).getHours(), " :  ").concat(new Date(time).getUTCMinutes(), "</span>\n                                </a>\n\n                                <span class=\"text-muted\"> Status: ").concat(e.statues, "</span>\n                            </div>\n\n                        </li>"));
    document.getElementById('notifications_count').innerHTML = e.count;
  }
});
/**
